...
from Gojo import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from Gojo.__main__ import STATS, TOKEN, USER_INFO
...
from Gojo.modules.sql.afk_sql import is_afk, check_afk_status
...
from Gojo import telethn as GojoTelethonClient
