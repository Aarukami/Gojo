...
from Gojo.extrastuff import SUDOERS
from Gojo import LOG_GROUP_ID
from Gojo import pgram as app 
from Gojo.arqclient import arq
from Gojo.utils.keyboard import ikb
...
from Gojo.modules.music import download_youtube_audio
...
async def inline_help_func(__help__):
    ...
    answerss = [
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(
                "https://github.com/Aarukami/Gojo"
            ),
...
async def alive_function(answers):
    ...
    msg = f"""
**[Gojo✨](https://github.com/Aarukami/Gojo.git):**
**RoBot:** `{bot_state}`
