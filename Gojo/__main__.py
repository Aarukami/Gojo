...
GOJO_IMG = "https://telegra.ph/file/4386f835945e75eaeff28.jpg"
...
PM_START_TEXT = """
This is Gojo[.](https://telegra.ph/file/4386f835945e75eaeff28.jpg)
...
buttons = [
    [
        InlineKeyboardButton(
            text="🏹Summon ME🏹",url="/t.me/chifuyumatsuno_RoBot?startgroup=true"
        ),
    ],
    [
        InlineKeyboardButton(
...
HELP_STRINGS = """
`Hey there! My name is` [Gojo!](https://telegra.ph/file/4386f835945e75eaeff28.jpg) 
I'm a Gojo the strongest  and help admins manage their groups with Some Powerful Features! \n`Have a look at the following for an idea of some of the things I can help you with.`"""
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  ...
                  [
                  InlineKeyboardButton(text="Sᴏᴜʀᴄᴇ", url="https://github.com/Aarukami/Gojo.git")
                  ]
                ]
            ),
        )
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..👩‍💼 I'm *Emilia*
                 \nMy Source Code Can be Found at Github at this [Link](https://github.com/Aarukami/Gojo.git""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
